# Accessibility Statement – Codex Slicer Bar

## Overview
This document outlines the accessibility compliance of the **Codex Slicer Bar** Power BI custom visual.
...
## 7. Summary
**Codex Slicer Bar** meets Microsoft's accessibility requirements and is designed to be usable by all users, including those relying on assistive technologies.